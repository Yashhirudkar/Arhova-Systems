        ...
        <div className="bg-white rounded-lg overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row items-center py-12 px-8">
            <div className="lg:w-1/2 mb-8 lg:mb-0 lg:pr-8">
              <img 
                src="https://toposel.com/wp-content/uploads/2025/07/seo-toposel-image.jpg" 
                alt="Digital Marketing" 
                className="w-full rounded-lg"
              />
            </div>

            <div className="lg:w-1/2 max-w-[550px]">
              <h2 className="text-xl font-bold text-purple-600 mb-4">Digital Marketing</h2>
              <h3 className="text-4xl font-semibold leading-[48px] text-gray-900 mb-6">
          ...
          <div className="py-12 px-8 bg-gray-50 mt-10 mb-20">
            <div className="text-center mb-12">
              ...
              <h3 className="text-4xl font-semibold leading-[48px] text-gray-900">
            ...
            <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-6 rounded-lg flex flex-col items-center text-center border border-gray-300">
                ...
                <p className="text-gray-700 text-base">
                  Targeted paid campaigns for immediate results
                </p>
              </div>
          ...
          <div className="py-16 bg-purple-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-gray-900">Our Digital Marketing Impact</h2>
                <p className="text-lg text-gray-600 mt-4">Driving measurable results for our clients</p>
              </div>
              
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div className="text-center">
                  <div className="text-4xl font-bold text-purple-600">87%</div>
                  <div className="text-gray-600">Increase in Organic Traffic</div>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-600">ROI on Marketing Spend</div>
                </div>
                <div className="text-center">
          ...
          <div className="py-16 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-gray-900">Our Digital Marketing Process</h2>
                <p className="text-lg text-gray-600 mt-4">A structured approach to your success</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">Understanding your business and goals</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-600">Creating a customized marketing plan</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-600">Executing the strategy across channels</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-600">Continuous improvement based on data</p>
                </div>
              </div>
            </div>
          </div>
